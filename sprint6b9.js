...
const FINTECH_GLOSSARY=[
  {term:'Fintech',category:'Fintech Foundations',definition:'Technology-enabled products, platforms, and business models that deliver or improve financial services.'},
  {term:'Embedded finance',category:'Fintech Foundations',definition:'Financial services integrated directly into a nonfinancial product or customer experience.'},
  {term:'Banking as a Service (BaaS)',category:'Fintech Foundations',definition:'Infrastructure that lets companies offer banking capabilities through a regulated bank and technology partners.'},
  {term:'Platform banking',category:'Fintech Foundations',definition:'A model in which financial products and partner services are delivered through a shared digital platform.'},
  {term:'Neobank',category:'Fintech Foundations',definition:'A digitally focused financial-services provider that typically delivers banking experiences without traditional branches.'},
  {term:'Open banking',category:'Data & Connectivity',definition:'Permission-based sharing of financial-account data and services through standardized connections.'},
  {term:'Open finance',category:'Data & Connectivity',definition:'Permissioned financial-data sharing that extends beyond banking into lending, investments, insurance, and other services.'},
  {term:'Application programming interface (API)',category:'Data & Connectivity',definition:'A defined way for software systems to securely request data or functions from one another.'},
  {term:'API-first',category:'Data & Connectivity',definition:'A product approach that treats APIs as primary, reusable interfaces rather than secondary integrations.'},
  {term:'Webhook',category:'Data & Connectivity',definition:'An automated message one system sends to another when a specified event occurs.'},
  {term:'Aggregator',category:'Data & Connectivity',definition:'A provider that connects data or services from multiple financial institutions through one integration.'},
  {term:'Core banking system',category:'Banking Technology',definition:'The central system a financial institution uses to maintain accounts, balances, transactions, and product rules.'},
  {term:'Ledger',category:'Banking Technology',definition:'The authoritative record of financial entries, balances, and movements within a system.'},
  {term:'Double-entry accounting',category:'Banking Technology',definition:'An accounting method where every transaction creates equal and opposite entries to keep records balanced.'},
  {term:'Program manager',category:'Banking Technology',definition:'An organization that coordinates the operational, technical, and compliance elements of a financial product program.'},
  {term:'Digital onboarding',category:'Identity & Compliance',definition:'The remote process of enrolling and verifying a customer or business for a financial product.'},
  {term:'Customer identification program (CIP)',category:'Identity & Compliance',definition:'Procedures used by covered financial institutions to form a reasonable belief that they know a customer’s identity.'},
  {term:'Beneficial owner',category:'Identity & Compliance',definition:'A person who ultimately owns, controls, or benefits from a legal entity.'},
  {term:'Sanctions screening',category:'Identity & Compliance',definition:'Checking customers and transactions against applicable restrictions and watchlists.'},
  {term:'Transaction monitoring',category:'Identity & Compliance',definition:'Reviewing financial activity for patterns that may indicate fraud, money laundering, or other prohibited conduct.'},
  {term:'Regtech',category:'Identity & Compliance',definition:'Technology designed to help organizations manage regulatory obligations, controls, monitoring, and reporting.'},
  {term:'Alternative data',category:'Lending & Credit',definition:'Information outside traditional credit files that may help assess identity, affordability, or credit risk.'},
  {term:'Credit underwriting',category:'Lending & Credit',definition:'The process of evaluating an applicant’s ability and willingness to repay credit.'},
  {term:'Loan origination system (LOS)',category:'Lending & Credit',definition:'Software that supports the application, decisioning, documentation, and booking stages of a loan.'},
  {term:'Buy now, pay later (BNPL)',category:'Lending & Credit',definition:'Point-of-sale financing that divides a purchase into scheduled payments, subject to the provider’s terms.'},
  {term:'Annual percentage rate (APR)',category:'Lending & Credit',definition:'A standardized annual measure of borrowing cost that includes interest and certain fees.'},
  {term:'Delinquency',category:'Lending & Credit',definition:'A payment obligation that has not been satisfied by its required due date.'},
  {term:'Insurtech',category:'Fintech Sectors',definition:'Technology-enabled products and operating models used to distribute, price, administer, or improve insurance.'},
  {term:'Wealthtech',category:'Fintech Sectors',definition:'Technology that supports investing, financial advice, portfolio management, or wealth administration.'},
  {term:'Robo-advisor',category:'Fintech Sectors',definition:'A digital service that uses automated models to recommend or manage investment portfolios.'},
  {term:'Digital identity',category:'Identity & Compliance',definition:'A set of electronically verified attributes and credentials used to represent a person or organization.'},
  {term:'Stablecoin',category:'Digital Assets',definition:'A digital asset designed to maintain a relatively stable value by reference to another asset or mechanism.'},
  {term:'Digital wallet infrastructure',category:'Digital Assets',definition:'Technology used to create, secure, and operate software that holds or manages digital credentials or assets.'},
  {term:'Smart contract',category:'Digital Assets',definition:'Code deployed on a distributed ledger that executes defined actions when specified conditions are met.'},
  {term:'Decentralized finance (DeFi)',category:'Digital Assets',definition:'Financial applications delivered through blockchain-based protocols rather than traditional centralized intermediaries.'},
  {term:'Unit economics',category:'Product & Strategy',definition:'The revenue, direct cost, and contribution profile associated with one customer, account, or transaction unit.'},
  {term:'Customer acquisition cost (CAC)',category:'Product & Strategy',definition:'The average sales and marketing cost required to acquire a new customer.'},
  {term:'Lifetime value (LTV)',category:'Product & Strategy',definition:'An estimate of the economic value a customer generates across the relationship.'},
  {term:'Churn',category:'Product & Strategy',definition:'The rate at which customers, accounts, or revenue stop using a product during a period.'},
  {term:'Interoperability',category:'Product & Strategy',definition:'The ability of different systems, platforms, or networks to exchange information and work together.'},
  {term:'Financial inclusion',category:'Product & Strategy',definition:'Efforts to make useful, affordable financial products accessible to people and businesses that have been underserved.'}
];
GLOSSARY.push(...FINTECH_GLOSSARY);
...
function academyPage(){
  ...
  return `<div class="academy-luxe">
    <div class="pagehead academy-head"><div><div class="eyebrow">Payments and fintech mastery, beautifully organized</div><h1>Payments &amp; Fintech Academy</h1><p class="sub">A private luxury glossary and knowledge studio for the wider financial-technology ecosystem.</p></div><span class="pill">${GLOSSARY.length} essential terms</span></div>
    ...
    <article class="card academy-library"><details class="academy-term-drawer"><summary><span><span class="eyebrow">Complete reference</span><strong>Browse all Payments &amp; Fintech terms</strong></span><span class="pill">${GLOSSARY.length} terms</span></summary><div id="academyLibrary" tabindex="0" aria-label="Payments and fintech glossary terms"></div></details></article>
