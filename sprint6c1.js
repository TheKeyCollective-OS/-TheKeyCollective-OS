...
// Soft Sculpture Couture art direction: keep every autonomous surprise in the same cohesive visual family.
surprises.kiki.forEach(item=>{item[2]='assets/companion/kiki-soft-sculpture.png';item[3]='Kiki in her soft-sculpture business-lady look'});
surprises.lulu.forEach(item=>{item[2]='assets/companion/lulu-soft-sculpture.png';item[3]='Lulu in her soft-sculpture mommy cardigan'});
...
applySettings=()=>{applySettingsOriginal();const host=document.querySelector('#kikiCompanion'),cfg=companionConfig();if(!host)return;const mode=activeMode(),image=host.querySelector('img');image.src=mode==='lulu'?'assets/companion/lulu-soft-sculpture.png':'assets/companion/kiki-soft-sculpture.png';image.alt=mode==='lulu'?'Lulu, your gentle soft-sculpture dinosaur companion':'Kiki, your tiny soft-sculpture dinosaur companion'};
