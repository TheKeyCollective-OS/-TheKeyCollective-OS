...
function mount(){
  ...
  character.onclick=speak;character.onmouseenter=()=>{if(!character.dataset.hovered){character.dataset.hovered='1';speak();setTimeout(()=>delete character.dataset.hovered,6000)}};
