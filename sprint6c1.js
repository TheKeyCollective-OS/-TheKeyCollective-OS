...
const surprises={kiki:[['surprise-moonwalk','Tiny victory lap activated.'],['surprise-drag','Girl, I found something interesting and obviously had to investigate.'],['surprise-present','Emergency flower-delivery energy—no occasion needed.'],['surprise-dance','Bestie, new dance unlocked. Please remain impressed.']],lulu:[['surprise-present','Hey, Shug. I brought you a little softness today.'],['surprise-sway','Love, tiny tea-break energy?'],['surprise-hug','Baby girl, this is your reminder that you are deeply loved.'],['surprise-sway','Sweetheart, a little beauty found you today.']]};
...
function triggerSurprise(){const cfg=companionConfig();if(!cfg.enabled||!cfg.surprises)return;const list=surprises[activeMode()],item=list[Math.floor(Math.random()*list.length)];performMove(item[0],3200);say(item[1])}
