const CACHE='key-collective-6c3-theme-card-fix-16.55.24';
...
APP_SHELL.push('./app.css?v=16.55.24','./app.js?v=16.55.24','./sprint5.js?v=16.55.24','./assets/theme-amethyst-cheetah.png','./assets/theme-espresso-houndstooth.png','./assets/theme-onyx-bandana.png','./assets/theme-sapphire-stardust.png','./assets/theme-emerald-crocodile.png','./assets/theme-blackberry-deco.png','./assets/theme-rose-couture-tweed.png','./assets/theme-teal-murano.png','./assets/theme-ruby-velvet.png','./assets/theme-pearl-champagne-couture.png','./assets/theme-copper-chainmail.png','./assets/theme-platinum-deco-brocade.png');
