const CACHE='key-collective-6c3-rose-teal-16.55.19';
...
APP_SHELL.push('./app.css?v=16.55.19','./app.js?v=16.55.19','./sprint5.js?v=16.55.19','./assets/theme-amethyst-cheetah.png','./assets/theme-espresso-houndstooth.png','./assets/theme-onyx-bandana.png','./assets/theme-copper-microcheck.png','./assets/theme-sapphire-stardust.png','./assets/theme-emerald-crocodile.png','./assets/theme-blackberry-deco.png','./assets/theme-rose-couture-tweed.png','./assets/theme-teal-murano.png');
