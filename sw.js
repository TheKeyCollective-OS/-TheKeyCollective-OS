const CACHE='key-collective-6c3-emerald-blackberry-16.55.18';
...
APP_SHELL.push('./app.css?v=16.55.18','./app.js?v=16.55.18','./sprint5.js?v=16.55.18','./assets/theme-amethyst-cheetah.png','./assets/theme-espresso-houndstooth.png','./assets/theme-onyx-bandana.png','./assets/theme-rose-polka.png','./assets/theme-copper-microcheck.png','./assets/theme-sapphire-stardust.png','./assets/theme-emerald-crocodile.png','./assets/theme-blackberry-deco.png');
