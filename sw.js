const CACHE='key-collective-6c3-platinum-deco-16.55.23';
...
APP_SHELL.push('./app.css?v=16.55.23','./app.js?v=16.55.23','./sprint5.js?v=16.55.23','./assets/theme-amethyst-cheetah.png','./assets/theme-espresso-houndstooth.png','./assets/theme-onyx-bandana.png','./assets/theme-copper-microcheck.png','./assets/theme-sapphire-stardust.png','./assets/theme-emerald-crocodile.png','./assets/theme-blackberry-deco.png','./assets/theme-rose-couture-tweed.png','./assets/theme-teal-murano.png','./assets/theme-ruby-velvet.png','./assets/theme-pearl-champagne-couture.png','./assets/theme-copper-chainmail.png','./assets/theme-platinum-deco-brocade.png');
